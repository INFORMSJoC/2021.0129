from Func_S_NBD_I_20_J_50 import *
...
for i in range(len(I_all)):
    for j in range(len(J_all)):
        for k in range(len(K_all)):
            ...
            print('='*60)
            print('         S-NBD_Capacitated_Instance_I_{}_J_{}_K_{}'.format(I, J, K))
            print('='*60)
            ...
            UB, LB, UB_all, run_time_dec_RMP_all, run_time_MICP_all, time_loop_all, \
            cycle_all, gap_all, gap_prime_all, run_time_all, time_all, run_time_QLP \
                = S_NBD_I20_J50(I, J, K, M_k, A, b, COV_inverse_sqrt, d_bar,
