...
def decompose_RMP(I, J, K, L, M_k, A_k, b_k, Sigma_k, d_bar_k, d_uk, d_lk, sigma_k,
    ...
    obj_val, alpha_star, beta_u_star, beta_l_star, rho_star, \
        run_time_FYRMP = fix_y_RMP(y_star_dec_temp, I, J, K, L, M_k,
    ...
    print("computation time: {}".format(run_time_dec_RMP))
    print("*" * 60)
    print("*" * 60)
...
def S_NBD_I20_J50(I, J, K, M_k, A_k, b_k, Sigma_k, d_bar_k, d_uk, d_lk,
                  sigma_k, c, f, p, q, r, file_nameg):
    ...
    while (flag == 1 and UB_temp > (LB_temp + 0.5)):
