...
def direct_RMP(I, J, K, L, M_k, A_k, b_k, Sigma_k, d_bar_k,
               ...
               f, p, q, r):
    print("*" * 60)
    print("Soving Relaxed Master Problem start")
    ...
    print("Soving Relaxed Master Problem end")
...
def BD_I10_J30(I, J, K, M_k, A_k, b_k, Sigma_k, d_bar_k, d_uk, d_lk, sigma_k, c, f, p, q, r, file_nameg):
