...
def S_NBD_I20_J20(I, J, K, M_k, A_k, b_k, Sigma_k, d_bar_k, d_uk, d_lk, sigma_k, c, f, p, q, r, file_nameg):
    ...
    while (flag == 1 and (LB_temp + 0.5) < UB_temp ):
        ...
        if (I==20 and J==20 and K==5 and L==5):
