...
def S_NBD_I10_J20(I, J, K, M_k, A_k, b_k, Sigma_k, d_bar_k, d_uk, d_lk, sigma_k, c, f, p, q, r, file_nameg):
    ...
    while (flag == 1):
        ...
        print()
        print("=" * 60)
        print("              I_{}_J_{}_K_{}:第{}次循环".format(I, J, K, times))
        ...
        print("-" * 60)
        print('              The {}the computation time: {}'.format(times,
